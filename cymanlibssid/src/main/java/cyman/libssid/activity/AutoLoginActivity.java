...
//        getProviderData();
    ...
    public void sendEmailVerificationWithContinueUrl() {
        ...
        ActionCodeSettings actionCodeSettings = ActionCodeSettings.newBuilder()
                ...
                .setAndroidPackageName("com.e.caymanssidlib", false, null)
                .build();
    ...
    public void sendPasswordReset() {
        ...
        FirebaseAuth auth = FirebaseAuth.getInstance();
        String emailAddress = "abhishek@klizos.com";
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(AutoLoginActivity.this, "Authentication failed.",
    ...
    public void verifySignInLink() {
        ...
        if (auth.isSignInWithEmailLink(emailLink)) {
            ...
            String email = "abhishek@klizos.com";
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onCodeSent(String verificationId,
                        ...
                        AutoLoginActivity.this.enableUserManuallyInputCode();
                    }
